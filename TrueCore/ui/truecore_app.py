...
from TrueCore.utils.runtime_info import resource_path, runtime_state_path
...
def load_dev_tracker():
    ...
    path = runtime_state_path("dev_tracker.json")
...
def load_rotation():
    ...
    path = runtime_state_path("rotation_state.json")
