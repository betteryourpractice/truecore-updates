...
class TrueCorePipeline:
    ...
    def run(self, packet):
        ...
        packet.output["packet_semantic_coherence_score"] = getattr(packet, "packet_semantic_coherence_score", None)
        packet.output["packet_semantic_coherence_band"] = getattr(packet, "packet_semantic_coherence_band", None)
        ...
        packet.output["semantic_adjudication_1"] = dict(getattr(packet, "semantic_adjudication", {}) or {})
