...
def build_structured_result(
    ...
    return {
        ...
        "core": {
            ...
            "packet_evidence_score": getattr(packet, "packet_evidence_score", None),
            "packet_evidence_band": getattr(packet, "packet_evidence_band", None),
            "packet_assembly_score": getattr(packet, "packet_assembly_score", None),
            "packet_assembly_band": getattr(packet, "packet_assembly_band", None),
            "packet_profile": getattr(packet, "packet_profile", None),
            "packet_profile_label": getattr(packet, "packet_profile_label", None),
            "packet_archetype": getattr(packet, "packet_archetype", None),
            "packet_archetype_label": getattr(packet, "packet_archetype_label", None),
            "packet_archetype_description": getattr(packet, "packet_archetype_description", None),
            "packet_archetype_signals": list(getattr(packet, "packet_archetype_signals", []) or []),
            "packet_invariants": dict(getattr(packet, "packet_invariants", {}) or {}),
            "packet_invariant_coverage_score": getattr(packet, "packet_invariant_coverage_score", None),
            "packet_invariant_coverage_band": getattr(packet, "packet_invariant_coverage_band", None),
            "packet_variability": dict(getattr(packet, "packet_variability", {}) or {}),
            "packet_format_variability": getattr(packet, "packet_format_variability", None),
            "packet_variability_reasons": list(getattr(packet, "packet_variability_reasons", []) or []),
            "packet_failure_modes": list(getattr(packet, "packet_failure_modes", []) or []),
            "packet_failure_mode_labels": list(getattr(packet, "packet_failure_mode_labels", []) or []),
            "packet_failure_mode_summaries": list(getattr(packet, "packet_failure_mode_summaries", []) or []),
            "packet_classification_caution": bool(getattr(packet, "packet_classification_caution", False)),
            "packet_confidence_penalty": getattr(packet, "packet_confidence_penalty", 0.0),
